...
using ToeicSpace.Assessment.Domain.Exceptions;
...
public class GlobalExceptionHandler : IExceptionHandler
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        // Raised when two requests edit the same question concurrently (Version concurrency token).
        ...
        await HandleUnhandledExceptionAsync(httpContext, exception, cancellationToken);
        return true;
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        _logger.LogWarning(
            "Handled assessment application exception. Type: {Type}, Code: {Code}, Message: {Message}",
            exception.Type,
            exception.Code,
            exception.Message);
    ...
    private async Task HandleUnhandledExceptionAsync(
        ...
        CancellationToken cancellationToken)
    {
        _logger.LogError(exception, "Unhandled exception occurred in Assessment service");
    ...
    private static string MapToTitle(ErrorType type) => type switch
    {
